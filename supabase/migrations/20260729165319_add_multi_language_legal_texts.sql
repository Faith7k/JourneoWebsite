ALTER TABLE public.site_settings
  ADD COLUMN IF NOT EXISTS privacy_policy_text_tr TEXT,
  ADD COLUMN IF NOT EXISTS privacy_policy_text_en TEXT,
  ADD COLUMN IF NOT EXISTS terms_of_service_text_tr TEXT,
  ADD COLUMN IF NOT EXISTS terms_of_service_text_en TEXT,
